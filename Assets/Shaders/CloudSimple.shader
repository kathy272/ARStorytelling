...
Shader "CloudSimple"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#endif //aseld
			float dotResult42 = dot( ase_worldViewDir , -ase_worldlightDir );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			o.Normal = ( pow( saturate( dotResult42 ) , 6.420224 ) * 1.49 * ase_lightColor ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-2016,704;Float;False;Property;_midYValue;midYValue;5;0;Create;True;0;0;0;False;0;False;-1.053197;-2.07;-3;5;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3D9BEF252657AA9883FCFD0424EDE4C706EDC03E